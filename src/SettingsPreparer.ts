class SettingsPreparer {
	...
	insertSidebarLink(): void {
		...
		const sidebarElementJson: HtmlElement = {
			element: "li",
			attributes: {
				class: class_list,
		...
		const sidebarElement: HTMLElement = this.utility.createHtmlFromJson(sidebarElementJson);
	...
	addMiniNavButton(parent: Element): void {
		...
		const navButtonJson: HtmlElement = {
			element: "li",
			attributes: { class: "css-i3c1s5-view-listItem" },
			children: [
				{
					element: "a",
					attributes: { class: "css-al447q-view--block-link" },
					href: "/deadline-dynamo",
					children: [
						{
							element: "span",
							attributes: { class: "css-10d73cs-view--flex-flex" },
							children: [
								{
									element: "span",
									attributes: {
										class: "css-w1drs0-view-flexItem deadline-dynamo-mininav-icon"
									},
									innerHTML:
								...
								},
								{
									element: "span",
									attributes: {
										class: "css-oowy02-view-flexItem"
									},
									children: [
										{
											element: "span",
											attributes: {
												class: "css-1vfp3rz-text"
											},
											innerHTML: "Deadline Dynamo"
										}
									]
								}
							]
	...
	addHeader(): void {
		...
		const headerJson: HtmlElement = {
			element: "div",
			attributes: {
				class: "ic-app-nav-toggle-and-crumbs no-print"
			},
			children: [
				{
					element: "button",
					attributes: {
						id: "courseMenuToggle",
						class: "Button Button--link ic-app-nav-toggle"
					},
					children: [
						{
							element: "i",
															...
															children: [
																{
																	...
																	attributes: {
																		class: "icon-home",
																		title: "Deadline Dynamo Settings"
																	},
																	children: [
																		{
																			element: "span",
		...
		const header: HTMLElement = this.utility.createHtmlFromJson(headerJson);
	...
	createNav(): HTMLElement {
		...
		const nav: HTMLElement = this.utility.createHtmlFromJson(navJson);
		...
		for (const link of links) {
			const listItemJson: HtmlElement = {
				element: "li",
				attributes: {
					class: "section"
				},
				children: [
					{
						element: "a",
						href: `${this.link}/${link[0]}`,
						textContent: link[1]
					}
				]
			};

			const listItem: HTMLElement = this.utility.createHtmlFromJson(listItemJson);
